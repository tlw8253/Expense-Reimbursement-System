...
public class AddOrEditAdminDTO {
	private Logger objLogger = LoggerFactory.getLogger(AddOrEditAdminDTO.class);
	...
	public AddOrEditAdminDTO(HashMap<String, String> hmDataElements) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AddOrEditAdminDTO other = (AddOrEditAdminDTO) obj;
